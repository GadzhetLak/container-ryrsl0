...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ryrsl0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ryrsl0.containers.anotherwebservice.com/
...
```
git clone git@github.com:GadzhetLak/container-ryrsl0.git
cd container-ryrsl0
```
...
```
docker attach container-ryrsl0
```
